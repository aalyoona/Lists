...
namespace LinkedList.Tests
{
    public class Tests
    {
        ...
        {
            LinkedLists actual = new LinkedLists(array);
            LinkedLists expected = new LinkedLists(expectedArray);
            actual.Add(value);
        ...
        {
            LinkedLists actualArr = new LinkedLists(arr);
            int actual = actualArr.GetLength();
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            LinkedLists a = new LinkedLists(array);
        ...
        [TestCase(new int[] { })]
        public void GetMaxElementTest_WhenListEmpty_ShouldNullReferenceException(int[] array)
        {
            LinkedLists actual = new LinkedLists(array);
            Assert.Throws<NullReferenceException>(() => actual.GetMaxElement());
        }

        [TestCase(new int[] { 111, 1, 1 }, 1)]
        [TestCase(new int[] { -1, -1, -2 }, -2)]
        [TestCase(new int[] { 0, 0, 0 }, 0)]
        [TestCase(new int[] { 5, 2, 1, 4, 3 }, 1)]
        [TestCase(new int[] { 1 }, 1)]
        [TestCase(new int[] { 22, 22, 22, 22, 22, 22 }, 22)]
        [TestCase(new int[] { 9, 4, 5, 7, 1 }, 1)]
        ...
        [TestCase(new int[] { })]
        public void GetMinElementTest_WhenListEmpty_ShouldNullReferenceException(int[] array)
        {
            LinkedLists actual = new LinkedLists(array);
            Assert.Throws<NullReferenceException>(() => actual.GetMinElement());
        }

        [TestCase(new int[] { 111, 1, 1 }, 0)]
        [TestCase(new int[] { -1, -1, -2 }, 0)]
        [TestCase(new int[] { 0, 0, 0 }, 0)]
        [TestCase(new int[] { 1, 2, 5, 4, 3 }, 2)]
        [TestCase(new int[] { 1 }, 0)]
        [TestCase(new int[] { 22, 22, 22, 22, 22, 22 }, 0)]
        [TestCase(new int[] { 1, 4, 5, 7, 9 }, 4)]
        ...
        [TestCase(new int[] { })]
        public void GetIndexOfMaxTest_WhenListEmpty_ShouldNullReferenceException(int[] array)
        {
            LinkedLists actual = new LinkedLists(array);
        ...
        [TestCase(new int[] { })]
        public void GetIndexOfMinTest_WhenListEmpty_ShouldNullReferenceException(int[] array)
        {
            LinkedLists actual = new LinkedLists(array);
        ...
        public void RemoveAllByValue(int value, int[] array, int expected, int[] exp)
        {
            ...
            Assert.AreEqual(expected, actual);
            LinkedLists expect = new LinkedLists(exp);
        ...
        public void AddLinkedListsToEndTest(int[] act, int[] add, int[] exp)
        {
            LinkedLists expected = new LinkedLists(exp);
            LinkedLists actual = new LinkedLists(act);
            LinkedLists AddToActual = new LinkedLists(add);
            actual.AddLinkedListToEnd(AddToActual);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void AddLinkedListsToBeginningTest(int[] act, int[] add, int[] exp)
        {
            LinkedLists expected = new LinkedLists(exp);
            LinkedLists actual = new LinkedLists(act);
            LinkedLists AddToActual = new LinkedLists(add);
            actual.AddLinkedListToBeginning(AddToActual);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void AddLinkedListsByIndexTest(int index, int[] act, int[] add, int[] exp)
        {
            LinkedLists expected = new LinkedLists(exp);
            LinkedLists actual = new LinkedLists(act);
            LinkedLists AddToActual = new LinkedLists(add);
            actual.AddLinkedListByIndex(index, AddToActual);
            Assert.AreEqual(expected, actual);
        }

        [TestCase(-1, new int[] { 2, 3, 4 }, new int[] { 2, 3, 4 })]
        public void AddLinkedListsByIndexTest_WhenIndexLessThanZero_ShouldIndexOutOfRangeException(int index, int[] act, int[] add)
        {
            LinkedLists actual = new LinkedLists(act);
            LinkedLists addact = new LinkedLists(add);
            Assert.Throws<IndexOutOfRangeException>(() => actual.AddLinkedListByIndex(index, addact));
        }

        [TestCase(5, new int[] { 2, 3, 4 }, new int[] { 2, 3, 4 })]
        public void AddLinkedListsByIndexTest_WhenIndexMoreLength_ShouldIndexOutOfRangeException(int index, int[] act, int[] add)
        {
            LinkedLists actual = new LinkedLists(act);
            LinkedLists addact = new LinkedLists(add);
            Assert.Throws<NullReferenceException>(() => actual.AddLinkedListByIndex(index, addact));
        }
